...
//Função que tira espaços em branco de uma string
...
int main(int argc, char** argv) {
	...
	do{
		...
		if((decisao != 1) && (decisao != 0) && (decisao != 4)){
		...
		switch(decisao) {
			...
			case 4:{
				system("clear");
				strBlank(p1);
				printf("\n\t\tTirando espaços em branco: %s", p1);
				getchar();
				break;				
			}
			case 0: {
				system("clear");
				printf("Obrigado por ultilizar nosso software.");
				getchar();
				break;				
			}
			default:{
